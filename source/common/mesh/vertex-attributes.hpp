#ifndef Project_VERTEX_ATTRIBUTES_H
#define Project_VERTEX_ATTRIBUTES_H

#include <glad/gl.h>

namespace Project {

    // Just as convenience, we write which location "we" use for each attribute in Project shader.
...
#endif //Project_VERTEX_ATTRIBUTES_H
