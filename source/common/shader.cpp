...
void Project::ShaderProgram::create() {
    //Create Shader Program
    program = glCreateProgram();
}

void Project::ShaderProgram::destroy() {
    //Delete Shader Program
    if(program != 0) glDeleteProgram(program);
    program = 0;
}

bool Project::ShaderProgram::attach(const std::string &filename, GLenum type) const {
    ...
    // string (const GLchar**): an array of sProjectce code strings.
...
bool Project::ShaderProgram::link() const {
    //Link
